package design_mode.state.test;

import com.automannn.design_mode.state.OOP_class.Bridge;
import com.automannn.design_mode.state.OOP_class.ShieldBuilder;
import com.automannn.design_mode.state.OOP_class.VehicleAbstractFactory;
import com.automannn.design_mode.state.OOP_class.WeaponIterator;
import com.automannn.design_mode.state.OOP_interface.Weapon;
import com.automannn.design_mode.state.entity_alive.HelperPersonProxy;
import com.automannn.design_mode.state.entity_alive.LongGe;
import com.automannn.design_mode.state.entity_alive.YuGe;
import com.automannn.design_mode.state.entity_logicalOperation.*;
import com.automannn.design_mode.state.entity_nonliving.*;
import com.automannn.design_mode.state.exception.SingletonException;
...
public class Test {
    ...
    public static void main(String[] args) {
       ...
       VehicleAbstractFactory carFactory=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.state." +
       ...
       carFactory.createWheel();
        ...
        VehicleAbstractFactory carFactory1=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.state." +
