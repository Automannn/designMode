package design_mode.mediator.test;

import com.automannn.design_mode.mediator.OOP_class.*;
import com.automannn.design_mode.mediator.OOP_interface.*;
import com.automannn.design_mode.mediator.entity_alive.*;
import com.automannn.design_mode.mediator.entity_logicalOperation.*;
import com.automannn.design_mode.mediator.entity_nonliving.*;
import com.automannn.design_mode.mediator.exception.SingletonException;
...
public class Test {
    ...
    public static void main(String[] args) {
       ...
       VehicleAbstractFactory carFactory=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.mediator." +
       ...
       carFactory.createWheel();
        ...
        VehicleAbstractFactory carFactory1=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.mediator." +
       ...
       //在这种情况，如果下雨，
        ...
        //特种部队到来，果断对龙哥使用访问者模式搜了一遍
        SimpleVisitor visitor = new SimpleVisitor();
        Access access = longGe;
        visitor.visit(access);

        //经历了这么多曲折的事情之后，中介者模式将二者的矛盾化解
        Mediator mediator = new CollisionMediator();
        mediator.createMediator(longGe,yuGe);
