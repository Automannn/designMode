...
import com.automannn.design_mode.mediator.able_interface.Stationable;
import com.automannn.design_mode.mediator.entity_logicalOperation.MoodStation;
import com.automannn.design_mode.mediator.entity_logicalOperation.MoodStationFactory;
...
public class Hero {
    ...
    public void saySorry(){
        System.out.println(name+": 对不起，是我冲动了");
    }
