package design_mode.bridge.test;

import com.automannn.design_mode.bridge.OOP_class.Bridge;
import com.automannn.design_mode.bridge.OOP_class.ShieldBuilder;
import com.automannn.design_mode.bridge.OOP_class.VehicleAbstractFactory;
import com.automannn.design_mode.bridge.OOP_class.WeaponIterator;
import com.automannn.design_mode.bridge.OOP_interface.Weapon;
import com.automannn.design_mode.bridge.entity_alive.HelperPersonProxy;
import com.automannn.design_mode.bridge.entity_alive.LongGe;
import com.automannn.design_mode.bridge.entity_alive.YuGe;
import com.automannn.design_mode.bridge.entity_logicalOperation.*;
import com.automannn.design_mode.bridge.entity_nonliving.*;
import com.automannn.design_mode.bridge.exception.SingletonException;
...
public class Test {
    ...
    public static void main(String[] args) {
       ...
       VehicleAbstractFactory carFactory=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.bridge." +
       ...
       carFactory.createWheel();
        ...
        VehicleAbstractFactory carFactory1=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.bridge." +
