package design_mode.command.test;

import com.automannn.design_mode.command.OOP_class.*;
...
import com.automannn.design_mode.command.entity_alive.*;
import com.automannn.design_mode.command.entity_logicalOperation.*;
import com.automannn.design_mode.command.entity_nonliving.*;
import com.automannn.design_mode.command.exception.SingletonException;
import day20180201.designMode.eighteen_Commond.Receiver;
...
public class Test {
    ...
    public static void main(String[] args) {
       ...
       VehicleAbstractFactory carFactory=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.command." +
       ...
       carFactory.createWheel();
        ...
        VehicleAbstractFactory carFactory1=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.command." +
