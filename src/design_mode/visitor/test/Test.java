package design_mode.visitor.test;
...
public class Test {
    ...
    public static void main(String[] args) {
       ...
       VehicleAbstractFactory carFactory=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.visitor." +
       ...
       carFactory.createWheel();
        ...
        VehicleAbstractFactory carFactory1=  VehicleAbstractFactory.getFactory("com.automannn.design_mode.visitor." +
